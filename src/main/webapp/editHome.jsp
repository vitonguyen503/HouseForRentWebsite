...
<nav class="bg-gray-800" style="width: 100%; position:fixed; top:0 ; z-index:1;">
    <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div class="relative flex h-16 items-center justify-between">
            ...
            <button style="width: 7%; margin-top: 3px; margin-right:1%"  onclick="redirectAdd()" type="button" class="btn btn-secondary">Add</button><%--            <button style="width: 7%; margin-top: 3px;" onclick="redirectLogin()" type="button" class="btn btn-secondary">Sign in</button>--%>
    ...
    <form>
        <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
                <b><p style="color: #000; font-size:30px; text-align:center; padding-top: 20px; padding-bottom:10px;" class="text-base font-semibold leading-7 text-gray-900">Chỉnh sửa bài đăng</p></b>
