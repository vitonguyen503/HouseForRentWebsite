        ...
        <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8" style="margin-top: 20px;">
            ...
            <div class="row">
                <div class="col-md-3">
                    <!-- Nửa đầu của dòng 1 -->
                    <div class="card">
                        <a href="TrangchuEditBaidang.jsp"><img style="max-width: 100%;" src="img/anh2.jpg" alt=""></a>
                    </div>
                </div>
                <div class="col-md-8">
                    <!-- Nửa sau của dòng 1 -->
                    <div class="card" style="border: 0;">
                        <b><a style="text-decoration: none; color:black;" href="TrangchuEditBaidang.jsp">Title</a></b>
                        <div>
