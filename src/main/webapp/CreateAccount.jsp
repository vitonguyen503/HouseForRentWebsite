...
<div class="container">
    <form class="form">
        <h3 style="color: coral; text-align: center">Create Account</h3>
        <p>${error}</p>
        <div class="mb-3">
        ...
        <div>
            <button onclick = "redirectLogin()" style="margin-right: 30px; margin-left: 50px; width: 150px" type="button" class="btn btn-secondary">Create Account</button>
