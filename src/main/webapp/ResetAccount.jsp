...
<div class="container">
    <form class="form">
        <h3 style="color: coral; text-align: center">Reset Password</h3>
        <p>${error}</p>
        <div class="mb-3">
        ...
        <div style="display: inline-block; ">
            <button onclick="redirectLogin()" style="margin-right: 30px; margin-left: 92px; width: 100px" type="button" class="btn btn-secondary">OK</button>
