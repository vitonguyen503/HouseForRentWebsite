...
<div class="container">
    <form class="form">
        ...
        <div class="mb-3 form-check">
            ...
            <a style="color:brown; margin-left: 40%" href="ResetAccountGuest.jsp">Reset Password</a>
        </div>
        <div style="display: flex; justify-content:center; align-items:center">
            <button onclick="redirectTrangchuGuest()" style="margin-right: 30px; width: 100px" type="button" class="btn btn-secondary">LogIn</button>
            <button onclick="redirectCreateAccountGuest()" type="button" class="btn btn-success" style="width: 100px;">SignUp</button>
        </div>
    </form>
</div>
<script>
