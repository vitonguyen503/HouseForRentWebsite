...
<div class="KhoiPhai">
    <div class="space-y-12">
        <div class="border-b border-gray-900/10 pb-12">
            <p style="color: #f3b4b4; font-size:30px; text-align:center; padding-top: 20px; padding-bottom:10px;" class="text-base font-semibold leading-7 text-gray-900">Edit phòng trọ</p>
            ...
            <fieldset>
                ...
                <div class="mt-6 space-y-6">
                    <div class="flex items-center gap-x-3">
                        ...
                        <label style="color: #fff; font-size:15px;" class="block text-sm font-medium leading-6 text-gray-900">Còn trống</label>
                    </div>
                    <div class="flex items-center gap-x-3">
                        <input name="push-notifications" type="radio" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600">
                        <label style="color: #fff; font-size:15px;" class="block text-sm font-medium leading-6 text-gray-900">Đã cho thuê</label>
                    </div>
                </div>
            </fieldset>
        </div>
        ...
        <div>
            <fieldset>
                ...
                <div class="mt-6 space-y-6">
                    <div class="flex items-center gap-x-3">
                        <input name="push-notifications" type="radio" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600">
                        <label style="color: #fff; font-size:15px;"  class="block text-sm font-medium leading-6 text-gray-900">Confirm</label>
                    </div>
                </div>
            </fieldset>
        </div>
        ...
        <div class="mt-6 flex items-center justify-end gap-x-6">
            <button onclick="redirectEdit()" type="button" class="text-sm font-semibold leading-6 text-gray-900" style="color: #fff; font-size:15px;">Cancel</button>
